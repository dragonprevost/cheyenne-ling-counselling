    ...
    <div className="flex items-center justify-center">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md w-full max-w-md text-center">
        ...
        <div className="mb-4">
          ...
          <a href="tel:+16045551234" className="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">
            +1 (604) 555-1234
          </a>
        </div>
        ...
        <div>
          ...
          <a href="mailto:info@pembertonlandscaping.ca" className="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300">
            info@pembertonlandscaping.ca
          </a>
        </div>
      </div>
    </div>
